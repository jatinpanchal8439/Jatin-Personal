    ...
    <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-gradient-to-b from-background to-background/80">
      ...
      >
        ...
        >
          ...
          <Link href="https://wa.me/919760299195?text=Hello%20Jatin%2C%20I%20visited%20your%20portfolio!" className="bg-background hover:bg-primary/10 transition-colors p-3 rounded-full group">
